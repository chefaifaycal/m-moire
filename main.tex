...
\newpage
    ...
    \newpage
		...
		n'effectue aucune action jusqu'à la saisie d'un message.\newline
            ...
            \hline
            \end{tabular}
        \captionof{table}{Description textuel du cas d'utilisation Envoie de message}
        \end{minipage}
...
%Description Textuel du cas d'utilisation gestion de service
    \newpage
		...
		Le système renvoie l'utilisateur vers le scénario nominale Numéro 4.\newline
            ...
            \hline
            \end{tabular}
        \captionof{table}{Description textuel du cas d'utilisation Ajout de service}
        \end{minipage}
        
        %Cas d'utilisation modification de services
		...
		Le système renvoie l'utilisateur vers le scénario nominale Numéro 4.\newline
            ...
            \hline
            \end{tabular}
        \captionof{table}{Description textuel du cas d'utilisation Modification de service}
        \end{minipage}
        
        %cas d'utilisation suppression de service
        \newpage
        ...
        \centering
            ...
            \hline
            \end{tabular}
        \captionof{table}{Description textuel du cas d'utilisation Suppression de service}
        \end{minipage}
    \end{description}
	...
	de traduire le contenu conceptuel du diagramme de classes en modèle relationnel.
		...
		comme clé étrangère dans la table dérivée de l'entité de la cardinalité (?..*).
		    ...
		    (ses classes filles ne sont pas représentées par des relations).\cite{scenari-community}
                ...
                \begin{figure}[H]
                    \centering
                    \includegraphics[width=1\textwidth]{images/Screenshot 2021-09-26 at 11-31-04 Transformation de l'héritage en relationnel - rel3 pdf.png}
